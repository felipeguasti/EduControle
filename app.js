...
app.get(
  "/api/disponibilidade/:recurso/semana",
  disponibilidadeController.buscarReservasPorSemana
);
app.get(
  "/api/disponibilidade/:recurso/painel",
  disponibilidadeController.buscarReservasPorSemanaPainel
);
