document.addEventListener('DOMContentLoaded', function() {
    ...
    function setRecursoInfo() {
        ...
        document.getElementById('recursoInfo').textContent = 'Recurso selecionado: ' + recurso;
    }
    ...
    async function atualizarQuantidadeRecurso() {
        ...
        if (recurso) {
            ...
            if (quantidade !== null) {
                divQuantidade.textContent = `Quantidade: ${quantidade} dispositivo${quantidade > 1 ? 's' : ''}`;
            } else {
                divQuantidade.textContent = 'Quantidade não disponível para este recurso';
            }
        }
    }
    ...
    function atualizarOpcoesTurma(turno) {
        const opcoesMatutino = ['6ºM01', '6ºM02', '6ºM03', '6ºM04', '6ºM05', '7ºM01', '7ºM02', '7ºM03', '7ºM04', '8ºM01', '8ºM02', '8ºM03', '9ºM01', '9ºM02', '9ºM03', 'Reunião'];
        const opcoesVespertino = ['9ºM01', '1ºV01', '1ºV02', '1ºV03', '1ºV04', '1ºV05', '1ºV06', '2ºV01', '2ºV02', '2ºV03', '2ºV04', '3ºV01', '3ºV02', '3ºV03', 'Reunião'];
        ...
        fetch(`/api/disponibilidade/${recurso}?data=${data}&turno=${turno}`)
            ...
            .then(horarios => {
                ...
                for (const [horario, disponivel] of Object.entries(horarios)) {
                    ...
                    simboloSpan.classList.add(disponivel ? 'simbolo-disponivel' : 'simbolo-indisponivel');
    ...
    if (dadosFormulario.idReserva) { // Substitua 'idReserva' pelo campo correto
    ...
    document.querySelector('.close').addEventListener('click', fecharPopupProfessores);
    ...
    function carregarDetalhesReserva(reservaId) {
        fetch(`/api/reservas/${reservaId}`)
            ...
            .then(reserva => {
                ...
                if (reserva.data) {
                    const formattedDate = new Date(reserva.data).toISOString().split('T')[0];
    ...
    function preencherCabecalhoCalendario() {
        ...
        for (let i = 0; i < 5; i++) { // Apenas 5 dias da semana (segunda a sexta)
